...
namespace DepthsOfDarkness.Content.Items.Armor
{
	...
	public class DarknessAssassinHood : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			SetBonusText = this.GetLocalization("SetBonus").WithFormatArgs("Increases ranged critical strike chance and movement speed after striking an enemy");
		}
		...
		{
			return body.type == ModContent.ItemType<DarknessAssassinShirt>() && legs.type == ModContent.ItemType<DarknessAssassinPants>();
		}
		...
		public override void UpdateArmorSet(Player player)
		{
			...
			player.GetModPlayer<DepthsOfDarknessPlayer>().onHitDarknessOffensiveBuff = true;
		}
