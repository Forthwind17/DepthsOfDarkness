...
namespace DepthsOfDarkness.Content.Items.Armor
{
	...
	public class FrostCrown : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
            ...
            SetBonusText = this.GetLocalization("SetBonus").WithFormatArgs("The frost spirits will guard you");
        }
		...
		{
			return body.type == ModContent.ItemType<FrostShirt>() && legs.type == ModContent.ItemType<FrostPants>();
		}
		...
		public override void UpdateArmorSet(Player player)
		{
            ...
            player.GetModPlayer<DepthsOfDarknessPlayer>().frostSpiritBuff = true;
        }
