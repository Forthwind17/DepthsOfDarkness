...
namespace DepthsOfDarkness.Content.Items.Weapons.Ranger.Gun
{
	public class Ideal : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.UseSound = SoundID.Item40 with { Volume = 1.2f, Pitch = -0.5f };

			// Weapon Properties
			Item.DamageType = DamageClass.Ranged; // Sets the damage type to ranged.
            Item.damage = 263; // Sets the item's damage. Note that projectiles shot by this weapon will use its and the used ammunition's damage added together.
			Item.crit = 30;
			...
			Item.shootSpeed = 18.5f; // The speed of the projectile (measured in pixels per frame.)
		...
		public override void ModifyShootStats(Player player, ref Vector2 position, ref Vector2 velocity, ref int type, ref int damage, ref float knockback)
		{
			...
			{
				type = ModContent.ProjectileType<IdealProj>();
			}
