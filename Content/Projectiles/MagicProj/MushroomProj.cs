...
namespace DepthsOfDarkness.Content.Projectiles.MagicProj
{
    public class MushroomProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int d = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.GlowingMushroom, Projectile.velocity.X * 0.25f, Projectile.velocity.Y * 0.25f, 150, default, 0.5f);
        ...
        {
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, Main.rand.Next(-1, 1) * .25f, Main.rand.Next(-1, 1) * .25f, ModContent.ProjectileType<MushroomProj1>(), (int)(Projectile.damage * 0.75), 0, Projectile.owner);
        }
