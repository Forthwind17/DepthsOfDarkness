...
{
    public class OsmiumStaffProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.localAI[0] > 9f)
            {
                for (int i = 0; i < 4; i++)
                {
                    ...
                    int dust = Dust.NewDust(projectilePosition, 1, 1, DustID.PurpleCrystalShard, 0f, 0f, 0, default, 1f);
        ...
        public override void OnKill(int timeLeft)
        {
            for (int i = 0; i < 50; i++)
            {
                ...
                Dust d = Dust.NewDustPerfect(Projectile.Center + speed * 32, DustID.PurpleCrystalShard, speed * 2, Scale: 1.5f);
                d.noGravity = true;
                d.noLight = true;
            }
