...
{
    public class PermafrostAxeProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int num177 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.IceTorch, 0f, 0f, 140);
        ...
        {
            target.AddBuff(BuffID.Frostburn2, Main.rand.Next(120, 240), false);
        }
