...
namespace DepthsOfDarkness.Content.Projectiles.MeleeProj
{
	...
	public class OsmiumSwordProj : ModProjectile
	{
		...
		public override void AI()
		{
			...
			float scaleMulti = 0.4f; // Excalibur, Terra Blade, and The Horseman's Blade is 0.6f; True Excalibur is 1f; default is 0.2f 
		...
		public override bool PreDraw(ref Color lightColor)
		{
			...
			Color backDarkColor = new Color(103, 107, 185); // Original Excalibur color: Color(180, 160, 60)
			Color middleMediumColor = new Color(199, 168, 226); // Original Excalibur color: Color(255, 255, 80)
			Color frontLightColor = new Color(225, 201, 246); // Original Excalibur color: Color(255, 240, 150)
