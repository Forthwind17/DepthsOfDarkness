...
{
    public class CrimtaneScytheProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int num177 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.CrimtaneWeapons, 0f, 0f, 140);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.CrimtaneWeapons, Projectile.velocity.X * 0.1f, Projectile.velocity.Y * 0.1f);
            }
